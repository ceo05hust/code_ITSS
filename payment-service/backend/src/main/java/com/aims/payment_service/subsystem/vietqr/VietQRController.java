...
import com.aims.payment_service.subsystem.vietqr.request.QRAccessTokenRequest;
import com.aims.payment_service.subsystem.vietqr.request.QRGenerateRequest;
import com.aims.payment_service.subsystem.vietqr.response.QRAccessTokenResponse;
...
public class VietQRController implements IPaymentQRCode {
    ...
    public QRCode generateQRCode(Invoice invoice) {
        ...
        QRGenerateRequest generateRequest = QRGenerateRequest.builder()
                ...
                .content("AIMS " + invoice.getVietQrTransactionId()) // paymentRef là duy nhất
                .qrType(0)
                .orderId(invoice.getVietQrTransactionId())
                .transType("C")
                .build();
    ...
    public String checkPaymentStatus(Invoice invoice) {
        ...
        String requestBody = String.format(
                ...
                bankAccount, invoice.getVietQrTransactionId(), invoice.getTotalAmount(), bankCode
        );
